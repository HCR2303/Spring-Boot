...
class AuthorControllerTest {
    ...
    void getAuthors() {
        ...
        List<Author> actual = authorController.getAuthors().getResponse().getBody();
    ...
    void getAuthor() {
        ...
        ResponseEntity<Author> authorRE = authorController.getAuthor(idAuthor).getResponse();
    ...
    void getAuthorEmpty() {
        ...
        when(service.getById(1)).thenReturn(expected);
        ResponseEntity<Author> authorRE = authorController.getAuthor(1).getResponse();
        Author actualAuthor = authorRE.getBody();
    ...
    void createAuthor() throws URISyntaxException {
        ...
        ResponseEntity<Author> authorRE = authorController.createAuthor(expected).getResponse();
        Author actualAuthor = authorRE.getBody();
    ...
    void updateAuthor() throws URISyntaxException {
        ...
        ResponseEntity<Author> authorRE = authorController.updateAuthor((int) idAuthor, authorActualizado).getResponse();
        Author actualAuthor = authorRE.getBody();
    ...
    void updateAuthorNotFound() throws URISyntaxException {
        ...
        ResponseEntity<Author> userRE = authorController.updateAuthor((int) idAuthor, authorActualizado).getResponse();
    ...
    void deleteAuthor() {
        ...
        ResponseEntity<Void> userRE = authorController.deleteAuthor(idAuthor).getResponse();
