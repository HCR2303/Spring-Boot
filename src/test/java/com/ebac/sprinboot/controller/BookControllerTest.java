...
class BookControllerTest {
    ...
    void getBooks() {
        ...
        List<Book> actual = controller.getBooks();
    ...
    void getBook() {
        ...
        ResponseEntity<Book> bookRE = controller.getBook(idBook);
    ...
    void getBookNotFound() {
        ...
        when(service.getById(1)).thenReturn(expected);
        ResponseEntity<Book> bookRE = controller.getBook(1);
        Book actualBook = bookRE.getBody();
    ...
    void createBook() throws URISyntaxException {
        ...
        ResponseEntity<Book> bookRE = controller.createBook(expected);
        Book actualBook = bookRE.getBody();
    ...
    void updateBook() throws URISyntaxException {
        ...
        ResponseEntity<Book> bookRE = controller.updateBook((int) idBook, bookActualizado);
        Book actualBook = bookRE.getBody();
    ...
    void deleteBook() {
        ...
        ResponseEntity<Void> userRE = controller.deleteBook(idBook);
