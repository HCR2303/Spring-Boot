...
class UserControllerTest {
    ...
    void getUsers() {
        ...
        List<User> actual = userController.getUsers().getResponse().getBody();
    ...
    void getUser() {
        ...
        ResponseEntity<User> userRE = userController.getUser(idUser).getResponse();
    ...
    void getUserEmpty() {
        ...
        when(service.getById(1)).thenReturn(expected);
        ResponseEntity<User> userRE = userController.getUser(1).getResponse();
        User actualUser = userRE.getBody();
    ...
    void createUser() throws URISyntaxException {
        ...
        ResponseEntity<User> userRE = userController.createUser(expected).getResponse();
        User actualUser = userRE.getBody();
    ...
    void updateUser() {
        ...
        ResponseEntity<User> userRE = userController.updateUser((int) idUser, usuarioActualizado).getResponse();
        User actualUser = userRE.getBody();
    ...
    void deleteUser() {
        ...
        ResponseEntity<Void> userRE = userController.deleteUser(idUser).getResponse();
